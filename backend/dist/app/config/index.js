...
exports.default = {
    ...
    allowed: {
        ...
        suspend_time_failed_attempt: process.env.SUSPEND_MINUTES_FOR_FAILED_ATTEMPT,
        suspend_time_failed_reset_attempt: process.env.SUSPEND_MINUTES_FOR_FAILED_RESET_ATTEMPT,
        suspend_time_failed_verify_email_attempt: process.env.SUSPEND_MINUTES_FOR__FAILED_VERIFY_EMAIL_ATTEMPT,
    },
    cloudinary: {
